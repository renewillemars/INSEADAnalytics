...
# Set right directory
setwd("C:/Users/User/Documents/introtobda/introtobda/INSEADAnalytics/Project")
...
PlayoffTeamWins13 <- Teamstats2013$Wins[PlayoffTeams]
NonPlayoffTeamWins13 <- Teamstats2013$Wins[NonPlayoffTeams]
PlayoffTeams14 <- which(Teamstats2014$Playoffs == 1)
NonPlayoffTeams14 <- which(Teamstats2014$Playoffs == 0)
PlayoffTeamWins14 <- Teamstats2014$Wins[PlayoffTeams]
NonPlayoffTeamWins14 <- Teamstats2014$Wins[NonPlayoffTeams]
PlayoffTeams15 <- which(Teamstats2015$Playoffs == 1)
NonPlayoffTeams15 <- which(Teamstats2015$Playoffs == 0)
PlayoffTeamWins15 <- Teamstats2015$Wins[PlayoffTeams]
NonPlayoffTeamWins15 <- Teamstats2015$Wins[NonPlayoffTeams]
